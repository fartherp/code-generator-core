...
package com.github.fartherp.codegenerator.util;
...
public class JavaBeansUtils {
    ...
    public static String dealTableName(String name) {
        if (name.indexOf("tb_") == 0) {
            name = name.replaceFirst("tb_", "");
        } else if (name.indexOf("td_") == 0) {
            name = name.replaceFirst("td_", "");
        }
    ...
    public static String dealColumnName(String name) {
        if (name.indexOf("tb_") == 0) {
            name = name.replaceFirst("tb_", "");
        } else if (name.indexOf("td_") == 0) {
            name = name.replaceFirst("td_", "");
    ...
    public static Method getJavaBeansGetter(Field field) {
        Method method = new Method(JavaBeansUtils.getGetterMethodName(field.getName(), field.getType()));
