...
import com.github.fartherp.codegenerator.api.CommentGenerator;
...
public abstract class TableInfoWrapper<T extends AbstractAttributes> {
    ...
    public TableInfoWrapper(CodeGenContext context) {
        ...
        String rule = context.getRule() == null ? "baseRule" : context.getRule();
        this.rules = ExtensionLoader.getExtensionLoader(Rules.class, RULE_PATH).getExtension(rule);
